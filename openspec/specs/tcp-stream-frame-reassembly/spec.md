...
- GIVEN noise bytes followed by a valid frame start
- WHEN the extractor scans the buffer
- THEN noise bytes before SOI are discarded
- AND the valid frame is still emitted when complete
